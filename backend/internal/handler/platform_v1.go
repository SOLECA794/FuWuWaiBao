...
func (h *CompatibilityHandler) PlatformV1Overview(c *gin.Context) {
	...
	if err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{"code": 500, "message": "平台总览获取失败"})
		return
	}
...
func (h *CompatibilityHandler) PlatformV1Users(c *gin.Context) {
	...
	if err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{"code": 500, "message": "平台用户列表获取失败"})
		return
	}
	c.JSON(http.StatusOK, gin.H{"code": 200, "message": "请求成功", "data": data})
}
...
func (h *CompatibilityHandler) PlatformV1UserDetail(c *gin.Context) {
	...
	if err != nil {
		c.JSON(http.StatusNotFound, gin.H{"code": 404, "message": "平台用户详情获取失败"})
		return
	}
	c.JSON(http.StatusOK, gin.H{"code": 200, "message": "请求成功", "data": data})
}
...
func (h *CompatibilityHandler) PlatformV1SyncUser(c *gin.Context) {
	...
	c.JSON(http.StatusOK, gin.H{"code": 200, "message": "用户同步成功", "data": data})
}
...
func (h *CompatibilityHandler) PlatformV1Courses(c *gin.Context) {
	...
	if err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{"code": 500, "message": "平台课程列表获取失败"})
		return
	}
	c.JSON(http.StatusOK, gin.H{"code": 200, "message": "请求成功", "data": data})
}
...
func (h *CompatibilityHandler) PlatformV1CreateCourse(c *gin.Context) {
	...
	c.JSON(http.StatusOK, gin.H{"code": 200, "message": "课程创建成功", "data": data})
}

func (h *CompatibilityHandler) PlatformV1CourseDetail(c *gin.Context) {
	data, err := platformCourseDetail(h.db, c.Param("courseId"))
	if err != nil {
		c.JSON(http.StatusNotFound, gin.H{"code": 404, "message": "平台课程详情获取失败"})
		return
	}
	c.JSON(http.StatusOK, gin.H{"code": 200, "message": "请求成功", "data": data})
}
...
func (h *CompatibilityHandler) PlatformV1UpdateCourse(c *gin.Context) {
	...
	c.JSON(http.StatusOK, gin.H{"code": 200, "message": "课程更新成功", "data": data})
}
...
func (h *CompatibilityHandler) PlatformV1DeleteCourse(c *gin.Context) {
	...
	c.JSON(http.StatusOK, gin.H{"code": 200, "message": "课程删除成功", "data": data})
}
...
func (h *CompatibilityHandler) PlatformV1SyncCourse(c *gin.Context) {
	...
	c.JSON(http.StatusOK, gin.H{"code": 200, "message": "课程同步成功", "data": data})
}
...
func (h *CompatibilityHandler) PlatformV1Classes(c *gin.Context) {
	...
	if err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{"code": 500, "message": "平台班级列表获取失败"})
		return
	}
	c.JSON(http.StatusOK, gin.H{"code": 200, "message": "请求成功", "data": data})
}
...
func (h *CompatibilityHandler) PlatformV1CreateClass(c *gin.Context) {
	...
	c.JSON(http.StatusOK, gin.H{"code": 200, "message": "班级创建成功", "data": data})
}

func (h *CompatibilityHandler) PlatformV1ClassDetail(c *gin.Context) {
	data, err := platformClassDetail(h.db, c.Param("classId"))
	if err != nil {
		c.JSON(http.StatusNotFound, gin.H{"code": 404, "message": "平台班级详情获取失败"})
		return
	}
	c.JSON(http.StatusOK, gin.H{"code": 200, "message": "请求成功", "data": data})
}
...
func (h *CompatibilityHandler) PlatformV1UpdateClass(c *gin.Context) {
	...
	c.JSON(http.StatusOK, gin.H{"code": 200, "message": "班级更新成功", "data": data})
}
...
func (h *CompatibilityHandler) PlatformV1DeleteClass(c *gin.Context) {
	...
	c.JSON(http.StatusOK, gin.H{"code": 200, "message": "班级删除成功", "data": data})
}
...
func (h *CompatibilityHandler) PlatformV1Enrollments(c *gin.Context) {
	...
	if err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{"code": 500, "message": "平台选课列表获取失败"})
		return
	}
	c.JSON(http.StatusOK, gin.H{"code": 200, "message": "请求成功", "data": data})
}
...
func (h *CompatibilityHandler) PlatformV1CreateEnrollment(c *gin.Context) {
	...
	c.JSON(http.StatusOK, gin.H{"code": 200, "message": "选课创建成功", "data": data})
}
...
func (h *CompatibilityHandler) PlatformV1EnrollmentDetail(c *gin.Context) {
	...
	if err != nil {
		c.JSON(http.StatusNotFound, gin.H{"code": 404, "message": "平台选课详情获取失败"})
		return
	}
	c.JSON(http.StatusOK, gin.H{"code": 200, "message": "请求成功", "data": data})
}
...
func (h *CompatibilityHandler) PlatformV1UpdateEnrollment(c *gin.Context) {
	...
	c.JSON(http.StatusOK, gin.H{"code": 200, "message": "选课更新成功", "data": data})
}
...
func (h *CompatibilityHandler) PlatformV1DeleteEnrollment(c *gin.Context) {
	...
	c.JSON(http.StatusOK, gin.H{"code": 200, "message": "选课删除成功", "data": data})
}
