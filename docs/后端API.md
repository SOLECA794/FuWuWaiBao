...
- **功能**: AI自动生成讲稿内容
- **状态**: ⚠️ **模拟数据**（需接入真实AI服务）
- **说明**: 当前返回模拟讲稿数据，供前端开发调试使用。后续需由AI工程师接入真实大模型（如DeepSeek/OpenAI），根据课件内容动态生成专业讲稿。
...
- **功能**: 获取AI解析拆解出的知识点层级结构
- **状态**: ⚠️ **模拟数据**（需接入真实AI服务）
- **说明**: 当前返回固定的示例结构。后续需由AI工程师解析课件内容，提取核心知识点并构建层级化的知识图谱。
...
- **功能**: 在学习某页时向AI提问（包含常规提问和圈选溯源提问）
- **状态**: ⚠️ **模拟数据**（需接入真实AI服务）
- **说明**: 当前返回固定格式的模拟答案。后续需由AI工程师接入大模型，实现基于当前页讲稿内容的上下文感知回答，以及圈选坐标定位的精准解答。
...
- **功能**: AI对该薄弱知识点进行重构和二次讲解
- **状态**: ⚠️ **模拟数据**（需接入真实AI服务）
- **说明**: 当前返回预设的讲解内容。后续需由AI工程师根据薄弱点名称动态生成讲解，包含代码示例和类比说明。
...
- **功能**: 根据薄弱点生成对应的检测习题
- **状态**: ⚠️ **模拟数据**（需接入真实AI服务）
- **说明**: 当前返回预设题目。后续需由AI工程师根据薄弱点动态生成题目，支持单选/多选等题型，并控制题目难度。
...
7. **AI接口说明**: 标有"⚠️ 模拟数据"的接口当前返回模拟数据，供前端开发调试使用。后续将由AI工程师接入真实大模型，实现智能化能力。
...
| 日期 | 版本   | 更新内容 |
|------|------|----------|
| 2026-03-06 | v2.0 | 添加AI接口状态说明，标注模拟数据接口 |
